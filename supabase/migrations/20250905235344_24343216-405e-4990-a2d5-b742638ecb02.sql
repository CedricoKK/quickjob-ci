-- Add sample jobs with correct enum values
...
('Chauffeur - Koko', 'Chauffeur personnel avec permis B valide. Véhicule fourni, horaires réguliers.', 'Bouaké', 'Koko', 'Belleville', 'livraison', 180000, 220000, (SELECT id FROM auth.users LIMIT 1), 'chauffeur@exemple.ci', '+225 07 08 09 10 11', false, false),
